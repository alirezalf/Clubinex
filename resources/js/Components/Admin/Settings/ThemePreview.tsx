    ...
    return (
        <div className="w-full h-full bg-gray-50 overflow-hidden flex text-right font-sans text-[10px]" style={style} dir="rtl">
            ...
            <style>{`
                ...
                .sidebar-texture-sea { background-image: url('/images/backgrounds/photo-1507525428034-b723cf961d3e.jpg'); background-size: cover; opacity: 0.3; }
                .sidebar-texture-sunset { background-image: url('/images/backgrounds/photo-1472120435266-53107fd0c44a.jpg'); background-size: cover; opacity: 0.3; }
                .sidebar-texture-space { background-image: url('/images/backgrounds/photo-1451187580459-43490279c0fa.jpg'); background-size: cover; opacity: 0.3; }
                .sidebar-texture-forest { background-image: url('/images/backgrounds/photo-1542273917363-3b1817f69a2d.jpg'); background-size: cover; opacity: 0.3; }
            `}</style>
        </div>
    );
}
