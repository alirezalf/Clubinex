...
export const getMenuItems = (badgeCount: number = 0, notificationCount: number = 0) => [
    ...
    { name: 'پیام‌ها و اعلان‌ها', icon: Bell, href: route('notifications.index'), group: 'support', badge: notificationCount },
...
export const getAdminItems = (badgeCount: number = 0, rewardsCount: number = 0) => [
    ...
    { name: 'مدیریت جوایز', icon: Gift, href: route('admin.rewards.index'), group: 'admin', badge: rewardsCount },
